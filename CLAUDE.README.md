...
```
/plugin marketplace add fxzer/claude-hud
```
...
<plugin>
  ...
  <repository>github.com/fxzer/claude-hud</repository>
  <license>MIT</license>
</plugin>
  ...
  <manifest_content>
    {
      ...
      "version": "0.0.1",
      "author": { "name": "fxzer", "url": "https://github.com/fxzer" }
    }
  </manifest_content>
...
<development>
  <setup>
    git clone https://github.com/fxzer/claude-hud
    cd claude-hud
    npm ci
    npm run build
  </setup>
...
<troubleshooting>
  <issue name="Statusline not appearing">
    ...
    <solution>Run: /plugin marketplace add fxzer/claude-hud</solution>
